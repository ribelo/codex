...
#[derive(Debug)]
pub(crate) struct ReviewToolCallCell {
    call_id: String,
    invocation: String,
...
impl ReviewToolCallCell {
    pub(crate) fn new(call_id: String, invocation: String, animations_enabled: bool) -> Self {
        Self {
            call_id,
            invocation,
            result: None,
    ...
    pub(crate) fn complete(&mut self, result: String, success: Option<bool>) {
        self.result = Some(result);
        self.success = success;
    }
}

impl HistoryCell for ReviewToolCallCell {
    fn display_lines(&self, width: u16) -> Vec<Line<'static>> {
...
pub(crate) fn new_active_review_tool_call(
    call_id: String,
    invocation: String,
    animations_enabled: bool,
) -> ReviewToolCallCell {
    ReviewToolCallCell::new(call_id, invocation, animations_enabled)
}
